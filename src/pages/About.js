...
function About() {
  return (
      ...
      <div className="aboutBottom">
        <h2> ABOUT ME</h2>
        <p>
        Hi, I'm ANUVARSHINI S and I'm excited to share my portfolio with you! I'm an UG student at Sri Krishna College Of Engineering & Technology.
...
I'm confident that I'll be able to make a positive contribution wherever I go.
        ...
        <p>
        In the future,I hope to be an engineer, and I'm excited to 
        ...
        In my free time,I enjoy taking photos of mine.I enjoy playing outdoor games . I believe that it's important to have a balance between work and play, and I find that help me to relax and recharge.
